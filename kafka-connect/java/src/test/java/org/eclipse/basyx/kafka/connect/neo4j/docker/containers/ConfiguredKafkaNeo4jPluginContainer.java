...
public class ConfiguredKafkaNeo4jPluginContainer extends GenericContainer<ConfiguredKafkaNeo4jPluginContainer> {
	...
	private Map<String, String> envVars() {
		return Map.of("CONNECT_BOOTSTRAP_SERVERS", "kafka:9092", "CONNECT_REST_ADVERTISED_HOST_NAME", "kafka-connect",
				"CONNECT_LOG4J_LOGGERS",
				"org.eclipse.basyx.kafka.connect.neo4j=DEBUG,org.apache.kafka.connect=INFO,org.apache.kafka.connect.runtime=INFO,io.pebbletemplates.pebble=TRACE",
				"BASYX_AAS_REPO_URL", "http://aas-environment:8081", "BASYX_NEO4J_TARGET_URL",
