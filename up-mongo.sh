...
# echo "Starting stack..."
docker-compose  --project-name knowledgegraph-v3 --file compose.yaml --file compose.override.yaml --file compose.mongo.yaml up  --detach --remove-orphans --force-recreate --renew-anon-volumes
# --file compose.yaml
source .env
